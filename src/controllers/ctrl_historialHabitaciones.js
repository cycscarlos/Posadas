...
// Nueva función para manejar la solicitud AJAX y renderizar la vista 'ficha-modal'
// exports.consultaFichaModal = async (req, res) => {
//   const clienteId = req.params.id;

//   try {
//     // Consulta para verificar pagos directamente
//     const verificarPagosQuery = `
//       SELECT p.*, mp.metodo
//       FROM pagos p
//       JOIN metodos_pago mp ON p.id_metodo_pago = mp.id_metodo_pago
//       WHERE p.id_cliente = ?`;
    
//     const pagosDirectos = await query(verificarPagosQuery, [clienteId]);
//     /*console.log('Verificación directa de pagos:', pagosDirectos);*/

//     // Consulta para verificar la reserva
//     const verificarReservaQuery = `
//       SELECT * FROM reservas
//       WHERE id_cliente = ? AND estado IN ('activa', 'pre-reservada')`;
    
//     const reservaActiva = await query(verificarReservaQuery, [clienteId]);
//     /*console.log('Verificación de reserva activa:', reservaActiva);*/
...
//       /*console.log('Pagos encontrados sin filtrar:', pagos);*/
